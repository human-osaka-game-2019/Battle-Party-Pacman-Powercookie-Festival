...
void Result::Process() {
	...
	if (one_or_two==one) {
		Draw(0, 0, 0xffffffff, 0.0f, 0.0f, 1920, 1080, 1.0f, 1.0f, RESULT_BACK_oneP);
	...
	if (one_or_two == two) {
		Draw(0, 0, 0xffffffff, 0.0f, 0.0f, 1920, 1080, 1.0f, 1.0f, RESULT_BACK_twoP);
